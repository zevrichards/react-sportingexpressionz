...
export const FONT_MAP = {
  ...
  'Argentina':        { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Belgium':          { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Colombia':         { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Germany':          { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Ireland':          { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Italy':            { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Mexico':           { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Portugal':         { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'Spain':            { fontFamily: 'AdidasWCFont',    color: 'white',   namePosition: 'top' },
  'USA':              { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'Canada':           { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'Brazil':           { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'Croatia':          { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'England':          { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'France':           { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'Japan':            { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'Netherlands':      { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
  'Korea':            { fontFamily: 'NikeWCFont',    color: 'white',   namePosition: 'top' },
};
